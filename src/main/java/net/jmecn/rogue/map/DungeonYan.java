...
import net.jmecn.rogue.math.Rect;
...
public class DungeonYan extends MapCreator {
	...
	private void generateRoom(Room room) {
		...
		case North:
			...
			door = new Vector2(halfW, height-1);
			break;
		case South:
			// SOUTH
		...
		case West:
			...
			newRoom.y = mid - halfH;
			door = new Vector2(width-1, halfH);
			break;
		default:
			// Nothing
		}
	...
	private void generateCorridor(Room room) {
		...
		case North:
			...
			door = new Vector2(1, height-1);
			junctionDoor = new Vector2(mid, 0);
			break;	
		case South:
			if (room.width <= 3) {
				mid = 1;
			...
			door = new Vector2(1, 0);
			junctionDoor = new Vector2(1, room.height-1);
			break;	
		case East:
			if (room.height <= 3) {
				mid = 1;
			...
			door = new Vector2(0, 1);
			junctionDoor = new Vector2(room.width-1, mid);
			break;	
		case West:
			if (room.height <= 3) {
				mid = 1;
			...
			door = new Vector2(width-1, 1);
			junctionDoor = new Vector2(0, mid);
			break;	
		default:
			break;	
		}
